...
<form id="form" action="" method="POST">
    ...
    <div class="field">
        ...
        <div class="control">
            <input id="emailInput" class="input is-rounded <?php if ($errors['email']) print 'is-danger'; else print 'is-black' ?>" type="email" name="email" placeholder="Ваше Email" value="<?php print $values['email']; ?>" />
        </div>
    ...
    <div class="field">
        ...
        <div class="control">
            <div class="select is-rounded is-black">
    ...
    <div class="field">
        ...
        <div class="control">
            <textarea id="bioText" name="bio" class="textarea <?php if ($errors['bio']) print 'is-danger'; else print 'is-black' ?>" placeholder="Расскажите немного о себе..."><?php print $values['bio']; ?></textarea>
        </div>
    ...
    <div class="field">
        <div class="control">
            <label class="checkbox">
                ...
                С <a href="#" class="has-text-black">контрактом</a> ознакомлен(а).
            </label>
        </div>
